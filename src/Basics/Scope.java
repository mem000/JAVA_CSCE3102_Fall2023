package Basics;// Fig. 6.9: Basics.Scope.java
// Basics.Scope class demonstrates field (or data member) and local variable scopes.
...
public class Scope {
    ...
    public static void main(String[] args) {
        ...
        useField(); // useField uses class Basics.Scope's field x
        useLocalVariable(); // useLocalVariable reinitializes local x
        useField(); // class Basics.Scope's field x retains its value

        System.out.printf("%nlocal x in main is %d%n", x);
        //System.out.printf("x data member: %d%n ", Basics.Scope.x);
    }
